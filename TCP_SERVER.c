...
// int main(){
//     int server_len,client_len,server_sockfd,client_sockfd;
...
//     memcpy(&client_ipaddr,&client_address.sin_addr.s_addr,4);
//     printf("Accept completed (IP address of client=%s port= %d)\n",
//           inet_ntoa(client_ipaddr),ntohs(client_address.sin_port));
//     while(1){
